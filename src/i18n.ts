...
export const resources = {
  en: {
    translation: 
    {
      ...
      howScoutReport1: 'Scouting report includes the player card, all available statistics from the last 365 days, as well as an analysis of Strengths, Weaknesses & Concerns, and a final Conclusion.',
