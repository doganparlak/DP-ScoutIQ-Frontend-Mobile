...
const RANGES: Record<string, { min: number; max: number }> = {
  ...
  'Total Duels': { min: 0, max: 10.0 },
  'Accurate Passes': { min: 0, max: 100 },
  'Error Lead To Goal': { min: 0, max: 1.0 },
  ...
  'Possession Lost': { min: 0, max: 10.0 },
  ...
  'Goals': { min: 0, max: 2.0 },
  'Offsides Provoked': { min: 0, max: 1 },
  'Aerials': { min: 0, max: 10.0 },
  ...
  'Tackles': { min: 0, max: 5.0 },
  'Turn Over': { min: 0, max: 5 },
  'Fouls Drawn': { min: 0, max: 3.0 },
