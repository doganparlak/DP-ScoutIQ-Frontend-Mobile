...
const RANGES: Record<string, { min: number; max: number }> = {
  ...
  'Tackles Won': { min: 0, max: 5.0 },
  'Big Chances Missed': { min: 0, max: 5.0 },
  'Chances Created': { min: 0, max: 5.0 },
  'Goals Conceded': { min: 0, max: 5.0 },
  ...
  'Dribbled Past': { min: 0, max: 7.0 },
  'Clearance Offline': { min: 0, max: 2.0 },
  'Through Balls': { min: 0, max: 1.0 },
  'Passes In Final Third': { min: 0, max: 10.0 },
};
