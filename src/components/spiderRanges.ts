...
const RANGES: Record<string, { min: number; max: number }> = {
  ...
  'Total Duels': { min: 0, max: 37.0 },
  'Accurate Passes': { min: 0, max: 134 },
  ...
  'Saves': { min: 0, max: 17.0 },
  'Touches': { min: 0, max: 156 },
  'Assists': { min: 0, max: 3.0 },
  'Minutes Played': { min: 0, max: 135.33 },
  'Dribble Attempts': { min: 0, max: 11.0 },
