...
const RANGES: Record<string, { min: number; max: number }> = {
  ...
  'Total Crosses': { min: 0, max: 15.0 },
  'Passes': { min: 0, max: 100.0 },
  'Offsides': { min: 0, max: 4.0 },
  'Aerials Lost': { min: 0, max: 16.0 },
  'Penalties Committed': { min: 0, max: 1.0 },
  'Possession Lost': { min: 0, max: 25.0 },
  'Long Balls': { min: 0, max: 47.0 },
  'Aerials Won': { min: 0, max: 14.0 },
  'Clearances': { min: 0, max: 21.0 },
  ...
  'Backward Passes': { min: 0, max: 15.0 },
