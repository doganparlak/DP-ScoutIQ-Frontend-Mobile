...
const RANGES: Record<string, { min: number; max: number }> = {
  'Blocked Shots': { min: 0, max: 2.0 },
  'Tackles Won': { min: 0, max: 3.0 },
  'Big Chances Missed': { min: 0, max: 1.5 },
  'Chances Created': { min: 0, max: 5.0 },
  'Goals Conceded': { min: 0, max: 2.0 },
  'Long Balls Won': { min: 0, max: 5.0 },
  ...
  'Fouls': { min: 0, max: 2.0 },
  'Hit Woodwork': { min: 0, max: 0.5 },
  'goals_from_events': { min: 0, max: 3.0 },
  'Total Duels': { min: 0, max: 8.0 },
  'Accurate Passes': { min: 0, max: 100 },
  'Error Lead To Goal': { min: 0, max: 0.5 },
  'Error Lead To Shot': { min: 0, max: 1.0 },
  'Key Passes': { min: 0, max: 4.0 },
  'Penalties Missed': { min: 0, max: 1.0 },
  'Yellow Cards': { min: 0, max: 0.5 },
  'Duels Won': { min: 0, max: 8.0 },
  'Rating': { min: 0, max: 10.0 },
  'Shots Total': { min: 0, max: 6.0 },
  'Shots On Target (%)': { min: 0, max: 100.0 },
  'Total Crosses': { min: 0, max: 8.0 },
  'Passes': { min: 0, max: 75.0 },
  'Offsides': { min: 0, max: 1.25 },
  'Aerials Lost': { min: 0, max: 8.0 },
  'Penalties Committed': { min: 0, max: 0.5 },
  'Possession Lost': { min: 0, max: 15.0 },
  'Long Balls': { min: 0, max: 10.0 },
  'Aerials Won': { min: 0, max: 8.0 },
  'Clearances': { min: 0, max: 5.0 },
  'Man Of Match': { min: 0, max: 1.0 },
  'Ball Recovery': { min: 0, max: 8.0 },
  'Red Cards': { min: 0, max: 1.0 },
  'Accurate Crosses': { min: 0, max: 5.0 },
  'Goals': { min: 0, max: 1.25 },
  'Offsides Provoked': { min: 0, max: 0.5 },
  'Aerials': { min: 0, max: 8.0 },
  'Saves': { min: 0, max: 8.0 },
  'Touches': { min: 0, max: 100 },
  'Assists': { min: 0, max: 1.25 },
  'Minutes Played': { min: 0, max: 90 },
  'Dribble Attempts': { min: 0, max: 5.0 },
  'Goalkeeper Goals Conceded': { min: 0, max: 3.0 },
  ...
  'Duels Lost': { min: 0, max: 8.0 },
  'Penalties Saved': { min: 0, max: 0.5 },
  'Saves Insidebox': { min: 0, max: 8.0 },
  'Shots Off Target': { min: 0, max: 3.0 },
  'Good High Claim': { min: 0, max: 3.0 },
  'Dispossessed': { min: 0, max: 5.0 },
  'Shots On Target': { min: 0, max: 5.0 },
  'Through Balls Won': { min: 0, max: 1.0 },
  'assists_from_events': { min: 0, max: 1.0 },
  'Duels Won (%)': { min: 0, max: 100.0 },
  'Punches': { min: 0, max: 2.0 },
  'Successful Dribbles': { min: 0, max: 3.0 },
  'Tackles Won (%)': { min: 0, max: 100.0 },
  'Interceptions': { min: 0, max: 3.0 },
  'Yellow & Red Cards': { min: 0, max: 1.0 },
  'Backward Passes': { min: 0, max: 10.0 },
  'Captain': { min: 0, max: 0.5 },
  'Own Goals': { min: 0, max: 1.0 },
  'Dribbled Past': { min: 0, max: 3.0 },
  'Clearance Offline': { min: 0, max: 1},
  'Through Balls': { min: 0, max: 1.0 },
  'Passes In Final Third': { min: 0, max: 8.0 },
};
