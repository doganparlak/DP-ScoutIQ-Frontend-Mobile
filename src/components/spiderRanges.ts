...
const RANGES: Record<string, { min: number; max: number }> = {
  ...
  'goals_from_events': { min: 0, max: 0.4 },
  ...
  'assists_from_events': { min: 0, max: 0.3 },
